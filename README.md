...
### Usage Instructions
1. Download and expand [SegmentationClassAug.zip](https://github.com/wangleihitcs/DeepLab-V1-PyTorch/tree/master/VOCdevkit) into VOC directory where SegmentationClass/ is present.
2. Download initialized models and data splits from [provided GoogleDrive](https://drive.google.com/open?id=15wx9vOM0euyizq-M1uINgN0_wjVRf9J3). Place in initmodel/ and splits/ directories.
